...
var student = 
    {"name": " Iryna ",
    "surname" : " Pozniak ",
    "rate": 29};//Create a variable student and set ‘name’, ‘surname’ and ‘rate’ in json format

    
console.log (`Student name is ${student.name}.`); //Output ‘name’ value
console.log (`Student rate changed to ${student.rate}.`);//Change ‘rate’ value and output it
...
let n2 = _.filter(students, {"rate" : 25}) ;
